 ...
 * data: { empleado_id, fecha, hora?, tipo_id, observaciones? }
 */
 ...
 * - empleadoId
 * - empresaId
 * - desde (fecha mínima, inclusive)
 * - hasta (fecha máxima, inclusive)
 * - tipoId
 */
 ...
 */
export async function findHistorialPorEmpleado(empleadoId, { desde = null, hasta = null } = {}) {
 ...
 */
export async function findAsistenciasPorEmpresa(empresaId, { desde = null, hasta = null } = {}) {
    return findAsistencias({
        empresaId,
        desde,
        hasta
